...
//       // Function to create gauge with adjusted position
//       const createGauge = (x, y, labels, initialAngle) => {
//         const gaugeGroup = svg.append('g').attr('transform', `translate(${x + 100}, ${y})`);  // Adjusted position to center within the same row
  
//         // Add enhanced 3D glass-like styling to the gauge
...
//         // Add enhanced 3D styling to the stroke with arrow shape
//         gaugeGroup.append('path')
//           .attr('d', 'M 0 -180 L 5 -175 L 0 -170 L -5 -175 Z')  // Adjusted path for larger gauge
...
//         // Define stroke gradient for 3D effect
...
//         // Add radial gradient effect with enhanced 3D glass-like colors
...
//         radialGradient.append('stop')
//           .attr('offset', '20%')
//           .attr('stop-color', 'rgba(230, 240, 255, 0.8)');
...
//         radialGradient.append('stop')
//           .attr('offset', '60%')
//           .attr('stop-color', 'rgba(170, 200, 255, 0.4)');
  
//         radialGradient.append('stop')
//           .attr('offset', '80%')
//           .attr('stop-color', 'rgba(140, 180, 255, 0.2)');
  
//         radialGradient.append('stop')
//           .attr('offset', '100%')
//           .attr('stop-color', 'rgba(110, 160, 255, 0.1)');
...
//         // Add thicker needle with shading
//         const needle = gaugeGroup.append('path')
//           .attr('d', 'M -2 0 L 2 0 L 0 -150 Z')
//           .attr('transform', `rotate(${initialAngle})`) // Start at specified initial angle
//           .style('fill', 'url(#needleGradient)') // Ensure consistent fill style
//           .style('filter', 'url(#needleShadow)');
        
//         // Apply CSS transition for smooth rotation
//         needle.node().style.transition = 'transform 1s ease-out 0.5s'; // 3s duration, 1s delay
  
//         // Update the transform property with a delay
//         setTimeout(() => {
//           if (labels === kwLabels) {
...
//         // Log the needle angles and corresponding texts for both gauges
//         console.log('kwNeedleAngle', kwNeedleAngle);
//         console.log('Corresponding Power Text:', getClosestLabelText(kwNeedleAngle, kwLabels));
  
//         console.log('rpmNeedleAngle', rpmNeedleAngle);
//         console.log('Corresponding RPM Text:', getClosestLabelText(rpmNeedleAngle, rpmLabels));
...
//             .text('0 kW'); // Initial placeholder text
  
//           // Transform the text after 2.5 seconds
//           setTimeout(() => {
...
//             .style('filter', 'drop-shadow(0 0 10px rgba(0, 0, 0, 0.7))')
//             .style('font-weight', 'bold')
//             .text('Loading...'); // Initial placeholder text
...
//         // Apply CSS transition to text for smooth change
...
//         // Update the text with a 1.5-second delay and animate opacity
//         setTimeout(() => {
//           if (labels === kwLabels) {
...
//           }
//           textElement.style('opacity', 1);
//         }, 2500); // 1.5 seconds delay to match needle animation
...
//       // Create left gauge starting at kwNeedleAngle
//       createGauge(200, 200, kwLabels, kwNeedleAngle);
//       // Create right gauge starting at rpmNeedleAngle
...
//         if (newRPM === '400') { // Example condition
