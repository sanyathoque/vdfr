...
//       // Metallic ring gradient for the outer edge
...
//       // Define stroke gradient for 3D effect (existing)
...
//       // Enhanced radial background gradient inside the gauge
...
//       // Needle gradient for metallic shine
...
//       // Subtle reflection overlay gradient
...
//         // Animate the needle starting position
...
//         // Central text for the gauge reading
//         if (labels === kwLabels) {
...
//         .selectAll('g')
//         .filter((d, i) => i === 0)
//         .select('path[d="M -3 0 L 3 0 L 0 -150 Z"]');
